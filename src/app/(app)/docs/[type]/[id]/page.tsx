...
export default async function DocEditPage({
  ...
  return (
    <>
      ...
      {/*
        key ผูกกับเลขที่เอกสาร เพื่อให้ตัวแก้ไขเริ่มใหม่ทั้งตัวตอนเอกสารเปลี่ยนจากร่างเป็นใบจริง

        จำเป็นเพราะตัวแก้ไขเก็บข้อมูลไว้ในหน่วยความจำฝั่งเบราว์เซอร์
        พอออกเลขแล้วโหลดหน้าใหม่ ข้อมูลจากเซิร์ฟเวอร์เปลี่ยนก็จริง แต่ของในหน่วยความจำไม่เปลี่ยนตาม
        กระดาษ A4 จะยังขึ้นลายน้ำว่าร่างและไม่มีเลขที่ ทั้งที่ออกเลขไปแล้ว
      */}
      <DocEditor
        key={row.code ?? "draft"}
        initial={model}
